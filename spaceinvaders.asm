...
ALIEN_REC_STATE          EQU ALIEN_RECORD_STATE
ALIEN_REC_TIMER          EQU ALIEN_RECORD_TIMER
ALIEN_REC_ROW            EQU ALIEN_RECORD_ROW
ALIEN_REC_COL            EQU ALIEN_RECORD_COL
ALIEN_REC_ROW_TYPE       EQU ALIEN_RECORD_ROW_TYPE
ALIEN_REC_REL_X          EQU ALIEN_RECORD_REL_X
ALIEN_REC_REL_Y          EQU ALIEN_RECORD_REL_Y
ALIEN_REC_FLAGS          EQU ALIEN_RECORD_FLAGS
PIA0_DATAA     EQU     $FF00
PIA0_CTRLA     EQU     $FF01
PIA0_DATAB     EQU     $FF02
PIA0_CTRLB     EQU     $FF03
